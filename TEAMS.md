...
Last updated: 2026-05-10. Total teams indexed: 112.

## Legend

- **Year reference:** links to the year file (e.g., `2024` -> [`years/2024.md`](years/2024.md)) or the [Pre-2017 Editions](README.md#pre-2017-editions-20092016) section
- **Award abbreviations:** GP = Grand Prize, RU = Runner-Up, AF = Audience Favorite, MIE = MIE Award, BP = Business Products, CP = Consumer Products, CS = Consumer Services, LS = Life Sciences, SE = Social Enterprise, TS = Tech Surge, PA = Poverty Alleviation, GF = Grand Finale (used in 2023)
- **Outcome marker** (italics at end of line) appears only for teams researched in [`OUTCOMES.md`](OUTCOMES.md). Absence means "not researched yet" rather than "operating."
...
- **iBesties** ([2014](README.md#pre-2017-editions-20092016): GP). Gina Heitkamp, Jenae Heitkamp. *Pivoted to "Middle School Moguls" in 2016 (Target shelves, Nickelodeon miniseries 2019); likely dormant after 2021.*
- **ImmunoTarget** ([2020](years/2020.md): LS 1st). Stephanie Hachey. *Operating as ImmunoTarget Therapeutics, Inc.; very early stage; still active per 2025 bioRxiv preprint.*
- **Instinct** ([2020](years/2020.md): BP 2nd). Sumanth Pallamreddy.
...
- **Repeat finalists across years** (Simon Loo, Pravin Surana, Daniel Dai, Dylan Riffle): see [Repeat finalists in README](README.md#repeat-finalists-across-years)
- **Two-team-same-year** (Donald "Don" Magnuson, 2017 Purist + COMPAS): see [Cross-Year Analytics in README](README.md#repeat-finalists-across-years)
- **Cross-listings** (teams winning both an overall award and a track award in the same year) are visible in each [year file](years/) where the same team name appears multiple times.
